...
export class MemStorage implements IStorage {
  ...
  async createCampaign(insertCampaign: InsertCampaign): Promise<Campaign> {
    ...
    const campaign: Campaign = {
      ...
      pointRules: insertCampaign.pointRules,
      spendAmount: insertCampaign.spendAmount ?? 100,
      earnPoints: insertCampaign.earnPoints ?? 5,
      minPurchaseAmount: insertCampaign.minPurchaseAmount ?? 0,
      referralDiscountPercentage: insertCampaign.referralDiscountPercentage ?? 10,
      pointsRedemptionValue: insertCampaign.pointsRedemptionValue ?? 100,
      pointsRedemptionDiscount: insertCampaign.pointsRedemptionDiscount ?? 10,
      termsAndConditions: insertCampaign.termsAndConditions ?? null,
